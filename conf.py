...
doc_name = 'OTRS Administration Manual'
...
project = 'OTRS Administration Manual'
...
latex_documents = [
    (master_doc, 'doc-admin.tex', 'OTRS Administration Manual',
     'OTRS AG', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'doc-admin', 'OTRS Administration Manual',
     author, 'doc-itsm', 'Administration manual for OTRS.',
     'Miscellaneous'),
]
